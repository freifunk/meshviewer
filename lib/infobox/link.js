...
export const Link = function (el, d, linkScale) {
  var self = this;
  ...
  self.render = function render() {
    ...
    helper.attributeEntry(
      ...
      children,
      "node.hardware",
      (d[0].source.model ? d[0].source.model + " – " : "") + (d[0].target.model ? d[0].target.model : ""),
    );
